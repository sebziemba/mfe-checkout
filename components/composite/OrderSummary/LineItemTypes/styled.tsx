...
export const LineItemFrequency: FC<React.HTMLAttributes<HTMLDivElement>> = (
  ...
  <div
    {...props}
    className="mt-2 flex bg-white border border-primary text-primary lg:mt-0 text-xs max-w-max py-1 px-2.5 rounded-sm lowercase font-normal first-letter:uppercase"
  />
)
...
> = (props) => {
  const lineItemOptionsStyles = {
    ...
    liSpan:
      "[&_li_span]:font-normal [&_li_span]:text-gray-500 [&_li_span]:ml-1 [&_li_span]:line-clamp-3 [&_li_span]:md:line-clamp-6",
  }
  return (
    <LineItemOptions
      {...props}
